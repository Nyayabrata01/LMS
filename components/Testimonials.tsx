...
const testimonials = [
  {
    ...
    rating: 5,
    content:
      "EduCode transformed my career! The courses are practical, and the referral program helped me earn while learning. I landed my dream job at Google within 6 months.",
  },
  {
    name: "Maria Garcia",
    role: "Data Scientist",
